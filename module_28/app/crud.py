...
def create_item(item: Item) -> Item:  new *
...
def get_item(item_id: int) -> Optional[Item]:  new *
    conn = get_db_connection()
    cursor = conn.cursor()
...
def update_item(item_id: int, item: Item) -> Optional[Item]:  new *
    conn = get_db_connection()
    cursor = conn.cursor()
...
def delete_item(item_id: int) -> bool:  new *
    conn = get_db_connection()
    cursor = conn.cursor()
